...
<title>My JSP 'patrolRecord.jsp' starting page</title>
...
<script type="text/javascript">
	$(function() {
		$("#patrolRecord").datagrid({
			iconCls : 'icon-save',
			title : '巡检系统统计',
			url : 'getAllPollTask_Bug.action',
			singleSelect : true,
			striped : true,//隔行变色
			rownumbers : true,
			...
			columns : [ [ {
				field : 'pollTask.task_id',
				title : '任务编号',
				align : 'center',
				width : 2
			}, {
				field : 'pollTask.task_name',
				title : '任务名称',
				align : 'center',
				width : 4
			}, {
