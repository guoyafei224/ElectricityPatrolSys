 ...
 * 类名称：MyWorkList <br>
 * 类描述： TODO(请输入类的描述) <br>
 * 创建人：郭亚飞 创建时间：2015-1-15 下午9:12:38 <br>
 * 修改人： 修改时间： <br>
 * 修改备注：
 * 
 * @version V1.0
...
public interface MyWorkListDao {
	...
	/**
	 * xitong管理员，根据个人id查询自己代办事项 创建时间：2015-1-16 下午3:44:24 <br>
	 * 消缺
	 * @param u_id
	 * @return
	 */
	public List<MyWorkList> byGuanBehe();
	 ...
	 * @return
	 */
	public List<MyWorkList> byGuanPoll();
